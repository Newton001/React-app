...
export default class Menu extends Component {
  ...
  <a href="index3.html" className="brand-link">
    <img src="dist/img/dekut.png" alt="DeKut Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
    <span className="brand-text font-weight-light">DeKUT</span>
  </a>
  {/* Sidebar */}
